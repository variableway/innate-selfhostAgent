  ...
  if (!mounted) {
    return (
      <div className="flex flex-col h-full overflow-auto">
        <div className="px-8 py-6 border-b shrink-0 space-y-4">
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="border rounded-lg p-4 bg-card space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-7 w-16 rounded-full bg-muted/60 animate-pulse" />
                </div>
              </div>
            ))}
          </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="font-medium whitespace-normal break-words [overflow-wrap:anywhere] group-hover:text-primary transition-colors">
                        {skill.title}
                      </h3>
                    </div>
